...
cp "$SRC/reference/security-checklist.txt" "$DEST/reference/security-checklist.txt"
cp "$SRC/reference/simplification-checklist.txt" "$DEST/reference/simplification-checklist.txt"
